                ...
                <div class="card mt-5">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="inputUser" class="col-md-6 col-lg-6 control-label">Username</label>
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="inputUser" name="inputUser"  placeholder="Username" name="username" autocomplete="off" >
                            </div>
                        </div>
                        <div class="form-group">
